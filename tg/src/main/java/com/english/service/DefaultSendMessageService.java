...
import static com.english.enums.Command.DEFAULT;

@Service
@RequiredArgsConstructor
@TelegramCommand(DEFAULT)
public class DefaultSendMessageService implements BotApiMethodMessageService {
    ...
    public BotApiMethodMessage createBotApiMethodMessage(Update update) {
        KeyboardRow keyboardRow = keyboardRowFactory.createKeyboardRows(Command.START);
